...
//  Project4
//
//  Created by Wen Chi on 10/26/18.
...
const char *WINDOWTITLE = { "Project#4 - Chi Wen" };
...
Display( )
{
    ...
    glPushMatrix();
    glShadeModel(GL_FLAT);
    glTranslatef(0., 3 * cos(2 * M_PI * Time), 6.);
    ...
    //SetSpotLight
    SetSpotLight(GL_LIGHT0, 0, 0., 0, 0, 0., 10, 0., 1., 0.);
    glPushMatrix();
    glDisable(GL_LIGHTING);
    glColor3f(0., 1, 0);
    ...
    //SetPointLight
    SetPointLight(GL_LIGHT2, 8 * cos(2 * M_PI * Time), 5., 8 * sin(2 * M_PI * Time), 0., 0., 1);
    glPushMatrix();
    glDisable(GL_LIGHTING);
    glColor3f(0., 0., 1);
    glTranslatef(8 * cos(2 * M_PI * Time), 4 * sin(2 * M_PI * Time), 8 * sin(2 * M_PI * Time));
    glutSolidSphere(0.5, 50, 50);
    glEnd();
    glEnable(GL_LIGHTING);
    glPopMatrix();
