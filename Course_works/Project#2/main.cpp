...
const char *WINDOWTITLE = { "Project#2 - Chi Wen" };
...
GLuint  ObjectList;             // inside-view object
...
Animate( )
{
    ...
    Time = (float)ms *7000 /  (float)MS_IN_THE_ANIMATION_CYCLE;        // [ 0., 1. )
...
Display( )
{
    ...
    if (WhichPerspective == INSIDE)
        ...
        gluLookAt(10., 8., 10., 0., 0., 1.5, 0., 1., 0.);
