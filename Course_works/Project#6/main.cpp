...
//  Project6
//
//  Created by Wen Chi on 11/19/18.
...
const char *WINDOWTITLE = { "Project#6 - Chi Wen" };
...
Display( )
{
    ...
    RotateY(&Curves[5].p1, 10 * sin(120 * M_PI * Time), 0, 0, 0);
    RotateY(&Curves[5].p2, -10 * sin(120 * M_PI * Time), 0, 0, 0);
    Curves[5].r = rgb[0]; Curves[5].g = rgb[1]; Curves[5].b = rgb[2];
    
    for (int eye_a = 6; eye_a <10;eye_a++){
        RotateX(&Curves[eye_a].p1, 3 * cos(120 * M_PI * Time), 0, 10, 0);
        RotateX(&Curves[eye_a].p2, 3 * cos(120 * M_PI * Time), 0, -10, 0);
    }
    
    for (int eyeline_a = 14; eyeline_a <21;eyeline_a+=4){
        RotateZ(&Curves[eyeline_a].p1, 15 * sin(30 * M_PI * Time), 2, 0, 10);
        RotateZ(&Curves[eyeline_a].p2, -5 * sin(30 * M_PI * Time), 0, 0, -10);
    }
    
    RotateY(&Curves[10].p1, 1 * sin(90 * M_PI * Time), 0, 5, 0);
    RotateY(&Curves[10].p2, -1 * sin(90 * M_PI * Time), 10, 0, 0);
    RotateY(&Curves[11].p1, 1 * sin(90 * M_PI * Time), 0, 5, 0);
    RotateY(&Curves[11].p2, -1 * sin(90 * M_PI * Time), 10, 0, 0);
