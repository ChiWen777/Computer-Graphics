...
//  Project5
//
//  Created by Wen Chi on 11/11/18.
...
const char *WINDOWTITLE = { "Project#5 - Chi Wen" };
...
Display( )
{
    ...
    gluLookAt( 0.2, 0.2, 10,     0., 0.5, 0.,     0., 1., 0. );
    ...
    ColorR = 0.3;
    ColorG = 0.6 * cos(90*Time);
    ColorB = 0.6 * sin(90*Time);
    
    Ka = 0.9;
    Kd = 0.9;
    Ks = 0.3;
    
    SpecularColorR = 0.3 * sin(10*Time);
    SpecularColorG = 0.2 * sin(10*Time);
    SpecularColorB = 0.5 * sin(10*Time);
...
InitGraphics( )
{
    ...
    bool valid = Pattern->Create("/Users/wenchi/Desktop/CS550/Projects/Project5/Project5/lighting.vert", "/Users/wenchi/Desktop/CS550/Projects/Project5/Project5/lighting.frag");
    if( ! valid )
    {
